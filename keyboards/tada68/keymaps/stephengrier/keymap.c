...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FL] = LAYOUT_65_ansi(
        ...
        _______,_______,KC_LSFT,KC_LALT,KC_LGUI,_______,_______,KC_LEFT,KC_DOWN,KC_RGHT,_______,_______,        _______,KC_END,
        _______,_______,BL_BRTG,BL_DOWN, BL_TOGG,BL_UP, _______,KC_MUTE,KC_VOLD,KC_VOLU,_______,KC_BTN1, KC_MS_U, KC_BTN2,
